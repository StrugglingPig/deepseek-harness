...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-finance-dashboard FinanceDashboard',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins FinanceSettingsPage id \'finance\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-finance-dashboard FinanceDashboardPanelIcon',
    ],
    replaceRisk: 'none',
