...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  financeEnableCoinGeckoRequestsHint: 'Requires a free CoinGecko API key. Reports quote community and developer counts for crypto instruments only.',
  financeCoinGeckoBaseUrl: 'CoinGecko API origin',
  financeCoinGeckoApiKey: 'CoinGecko API key',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  financeEnableCoinGeckoRequestsHint: '需要 CoinGecko API Key。仅对加密标的引用社区与开发数据。',
