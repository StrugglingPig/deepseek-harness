...
const EN: ReportCopy = {
  ...
  labels: {
    ...
    missingPositioning: 'CFTC positioning',
    missingEventRecord: 'the event timeline and announcement text',
    missingIndexValuation: 'index valuation and earnings',
    missingFundFlows: 'fund flows and positioning',
    missingMacroRegime: 'the macro regime series',
    asOf: 'As-of: ',
    price: 'Price: ',
    change: 'Change: ',
    bars: 'Bars: ',
  ...
  metrics: {
    ...
    totalDebt: 'Interest-bearing debt',
    cash: 'Cash and cash equivalents',
    operatingCashFlow: 'Operating cash flow',
    capex: 'Capital expenditure',
    freeCashFlow: 'Free cash flow',
    depreciation: 'Depreciation and amortization',
    stockBasedCompensation: 'Share-based compensation',
  ...
  blocks: {
    ...
    'event-context': { requires: ['the event timeline and announcement text', 'pre-event expectation'], checks: ['What changed versus the prior state?', 'How did price and volume react on the event bar?', 'Which assets transmit the impact?'] },
    ...
    'commodity-balance': { requires: ['energy inventories and the supply-demand balance', 'the cost curve and futures term structure'], checks: ['Is the market in surplus or deficit?', 'What is the marginal cost of supply?', 'How does the curve price storage and scarcity?'] },
    'fx-drivers': { requires: ['policy-rate differentials and currency legs', 'balance-of-payments series', 'CFTC positioning'], checks: ['Which leg drives the pair?', 'Is the move carry, terms of trade, or risk sentiment?', 'What policy shift would break the trend?'] },
  ...
  valuation: {
    ...
    labels: {
      ...
      shareCountNotice: 'A buyback is not credited per share: the cash it uses has left the business and reaches the valuation through net debt.',
...
const ZH: ReportCopy = {
  ...
  labels: {
    ...
    missingPositioning: 'CFTC 持仓',
    missingEventRecord: '事件时间线与公告原文',
    missingIndexValuation: '指数估值与盈利',
    missingFundFlows: '资金流与仓位',
    missingMacroRegime: '宏观状态序列',
    asOf: '截至：',
    price: '价格：',
    change: '涨跌幅：',
    bars: 'K 线数：',
  ...
  blocks: {
    ...
    'event-context': { requires: ['事件时间线与公告原文', '事件前预期'], checks: ['相对事件前状态发生了什么变化？', '事件当根 K 线的价格与成交量如何反应？', '影响通过哪些资产传导？'] },
    ...
    'commodity-balance': { requires: ['能源库存与供需平衡表', '成本曲线与期限结构'], checks: ['市场处于过剩还是缺口？', '边际供给成本在哪里？', '期限结构如何反映库存与稀缺？'] },
    'fx-drivers': { requires: ['政策利差与汇率腿', '国际收支序列', 'CFTC 持仓'], checks: ['哪一条腿主导该货币对？', '驱动来自 carry、贸易条件还是风险偏好？', '什么政策变化会打破趋势？'] },
  ...
  valuation: {
    ...
    labels: {
      ...
      shareCountNotice: '回购不按每股增厚计入：回购所用现金已离开公司，并通过净债务反映在估值中。',
