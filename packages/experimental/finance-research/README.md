...
- **Each upstream contributes the free endpoints a report reads** — Finnhub supplies the US equity context described below; CoinGecko supplies the coin's community, developer, all-time-high and all-time-low changes plus the global market snapshot; GitHub supplies repository counts, trailing commits, and the trailing-year release feed; FRED supplies the macro series, including the commodity benchmarks and currency legs the supply-demand and FX sections render; Binance supplies spot klines; CoinMarketCap supplies quotes and OHLCV; Yahoo supplies the equity price history; Polymarket supplies prediction markets; AKShare and iFinD supply the A-share fields.
