...
- **美股上下文数据需要 Finnhub Key** — 在金融设置中打开开关并保存密钥；一次美股查询会读取免费档的公司概况、指标集、同业公司、公司新闻、财报日历、EPS 超预期、内部人情绪与内部人交易、分析师评级趋势、SEC 公告以及已披露财报，用于填充估值、财务质量、竞争格局、股权与内部人、催化剂章节。单次查询共 11 次请求，符合免费档每分钟 60 次限额；未配置密钥时美股报告保留价格、宏观与技术面章节。
