...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshInstallAnchors: 'not a service: launcher-provided optional package.json path list (the dsh app plus every composed bundle); in-box plugin packages resolve from those installations first, in order — packages/client/modules/README.md owns the resolution contract',
