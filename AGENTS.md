...
- **A feature is a shipped plugin, an external plugin, or host code**; a bundle or profile row selects the first two, and only the third is unselectable ([glossary](docs/glossary.md#plugin-kinds)).
